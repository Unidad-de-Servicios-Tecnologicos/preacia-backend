...
CREATE TABLE IF NOT EXISTS vigencias (
    ...
    estado ENUM('pendiente', 'activa', 'cerrada') DEFAULT 'pendiente' COMMENT 'Estado de la vigencia',
...
CREATE TABLE IF NOT EXISTS usuarios (
    id INT AUTO_INCREMENT PRIMARY KEY,
    rol_id INT NOT NULL COMMENT 'Rol administrativo',
...
CREATE TABLE IF NOT EXISTS vigencia_lista_chequeo (
    ...
    activo BOOLEAN DEFAULT TRUE COMMENT 'Item activo para esta vigencia',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
8. POLÍTICA DE ELIMINACIÓN:
   ...
   - Se usa campo 'activo' (boolean) para desactivar/activar registros
   - Beneficios:
